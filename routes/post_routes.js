...
// function getOAuthClient() {
//     return new OAuth2('676417776639-2trgpdkf89jmt95l3joudfgjgdpn9fab.postRouters.googleusercontent.com', '0Y-yx7qHGQaD-d9Q-IdYx_hF', 'http://www.soulseeker.in');
// }
...
//         nJwt.verify(user.accessToken, keys.session.cookieKey, function (err, token) {
//             if (err) {
